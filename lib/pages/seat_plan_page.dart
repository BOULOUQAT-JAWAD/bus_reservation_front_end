import 'package:bus_reservation_front_end/customwidgets/seat_plan_view.dart';
...
import 'package:bus_reservation_front_end/utils/colors.dart';
        ...
        child: Column(
          children: [
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Container(
                            width: 20, height: 20, color: seatBookedColor),
                        const SizedBox(
                          width: 10,
                        ),
                        const Text(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Container(
                            width: 20, height: 20, color: seatAvailableColor),
                        const SizedBox(
                          width: 10,
                        ),
                        const Text(
            ...
            ValueListenableBuilder(
              ...
              // value is the real value(string) of selectedSeatStringNotifier
